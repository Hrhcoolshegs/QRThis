...
function QRThisApp() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
      {/* Floating Header */}
      <header className="sticky top-0 z-50 bg-black/90 backdrop-blur-xl border-b border-gray-700/40">
      ...
      <main className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group relative">
                ...
                <div className="relative bg-gray-800/50 border border-gray-700/50 rounded-2xl p-8 hover:border-gray-600 transition-all duration-300 hover:scale-105 hover:shadow-2xl backdrop-blur-sm">
        ...
        <section className="py-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Perfect for every use case</h2>
            <p className="text-lg text-gray-300">Ask our AI assistant how to optimize for your specific needs</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="flex items-start space-x-4 p-6 rounded-xl bg-gray-800/50 border border-gray-700/50 hover:border-gray-600 transition-all duration-200 hover:shadow-lg backdrop-blur-sm">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
                <span className="text-lg leading-relaxed text-gray-200">{useCase}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300">Get answers instantly</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="group bg-gray-800/50 border border-gray-700/50 rounded-2xl p-6 hover:border-gray-600 transition-all duration-300 hover:scale-105 hover:shadow-lg backdrop-blur-sm">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500/10 to-purple-600/10 rounded-xl flex items-center justify-center text-xl flex-shrink-0 group-hover:from-blue-500/20 group-hover:to-purple-600/20 transition-all duration-300">
                      {faq.icon}
                    </div>
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold mb-2 text-blue-400 group-hover:text-blue-300 transition-colors">
                        {faq.question}
                      </h3>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-700/40 bg-black/60 mt-20 backdrop-blur-sm">
        <div className="container max-w-7xl mx-auto px-4 py-12">
          <div className="text-center space-y-6">
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-lg font-semibold text-white">QRThis</span>
              <span className="text-xs bg-gradient-to-r from-blue-500 to-purple-500 text-white px-2 py-1 rounded-full font-semibold">
                AI-POWERED
              </span>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-8 text-sm text-gray-400">
              <span>Contact: <a href="mailto:contactqrthis@gmail.com" className="text-blue-400 hover:underline">contactqrthis@gmail.com</a></span>
              <span>•</span>
              <span>AI-powered, privacy-first, always</span>
              <span>•</span>
              <span>Made with ❤️ by <span className="text-white font-medium">Oluwasegun Akinshola Lawrence</span></span>
            </div>
          </div>
        </div>
      </footer>
...
const Index = () => {
  return (
    <ThemeProvider defaultTheme="dark" storageKey="qrthis-theme">
      <QRThisApp />
    </ThemeProvider>
  );
};
